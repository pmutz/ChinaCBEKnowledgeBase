...
This guide explains the steps required to set up the environment in Microsoft Azure. In case you prefer AWS, GPC or any other public cloud platform over Azure, please find their respective guides to set up a Python function, translator API, storage blob and the configuration of output bindings.
